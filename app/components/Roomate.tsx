...
export default function Roomate({name , profession, locations, lookingFor, gender, about, budget, image}:{name:string, profession:string, locations:string[], lookingFor:string, gender:string, about:string, budget:string, image:string}){
    ...
    //    <div className="grid grid-cols-3 w-full">
       ...
       return <div className=" shadow-md rounded-xl bg-cover p-4 gap-x-96 border border-white border-opacity-55 ">
        
       <div className="relative">
    <img className="w-full h-48 object-cover" src={image} alt="Profile Image"/>
  </div>

        <span className="text-3xl font-bold pt-8 lg:pt-0 bg-cover text-white">{name}</span>
        ...
        <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-white">
                ...
                <p className="pt-2 text-neutral-500  text-xs lg:text-sm flex items-center justify-center lg:justify-start whitespace-nowrap">
                    ...
                    </svg> Looking Around - {locations}
                </p>

                <p className="pt-8 text-sm text-white">{about}</p>
