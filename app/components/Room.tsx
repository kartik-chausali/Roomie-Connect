...
import { useIsChatOpen } from "@/store/chatStates"
...
export default function Room({images , propertyName , location , latitude , longitude , rent , roomType , about}:RoomProp){
  ...
  const nextSlide = () => {
    ...
    return <div className=" shadow-md rounded-xl bg-cover p-4 gap-x-96 border border-white border-opacity-55 ">
      ...
      <div className="flex justify-center mt-3 space-x-2">
        ...
        <span className="text-3xl font-bold pt-8 lg:pt-0 bg-cover text-white">{propertyName}</span>
